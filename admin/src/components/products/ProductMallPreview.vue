...
const displayShopName = computed(() => props.shopName || t('product.platformOwned'))
...
<template>
  <div class="mall-preview">
    <p class="mall-preview__tip">{{ t('product.mallPreviewTip') }}</p>
    <div class="product-card">
      ...
      <div class="product-info">
        <div class="product-name">{{ product.name || t('product.name') }}</div>
        <div class="shop-row">
          <span class="shop-row__name">{{ displayShopName }}</span>
